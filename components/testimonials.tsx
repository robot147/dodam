      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-6">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/docomo.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/au.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/fujitsu.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/jal.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/tepco.png" } width={180} height="50" alt='toshiba'></Image>
            </div>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-6">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/hana.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/shinhan.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/kb.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/ibk.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/mol.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/dtaq.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/kra.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/amore.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/missha.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/dasan.png" } width={180} height="50" alt='toshiba'></Image>
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={ "/images/energy.png" } width={180} height="50" alt='toshiba'></Image>
            </div>
